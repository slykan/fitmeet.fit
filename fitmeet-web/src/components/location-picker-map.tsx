          ...
          >
            <span
              style={{
                ...
                boxShadow: `0 0 2.5px rgba(10,20,20,${Math.min(streamOpacity * hubStreamBoost * 0.55, 0.55)}), 0 0 18px rgba(210,232,255,${Math.min(streamOpacity * hubStreamBoost, 1)})`,
          ...
          >
            <span
              style={{
                ...
                boxShadow: `0 0 2px rgba(10,20,20,${Math.min(opacity * hubParticleBoost * 0.6, 0.6)}), 0 0 16px rgba(210,232,255,${Math.min(opacity * hubParticleBoost, 1)})`,
