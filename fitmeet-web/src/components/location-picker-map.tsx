          ...
          >
            <span
              style={{
                ...
                boxShadow: `0 0 5px 1.5px rgba(6,10,10,${Math.min(streamOpacity * hubStreamBoost * 0.85, 0.85)}), 0 0 18px rgba(210,232,255,${Math.min(streamOpacity * hubStreamBoost, 1)})`,
          ...
          >
            <span
              style={{
                ...
                boxShadow: `0 0 4px 1.5px rgba(6,10,10,${Math.min(opacity * hubParticleBoost * 0.88, 0.88)}), 0 0 16px rgba(210,232,255,${Math.min(opacity * hubParticleBoost, 1)})`,
