...
import { fetchEventWeather, weatherIcon, weatherSlot, windFlowDirectionLabel, EventWeather } from '@/lib/weather'
    ...
    return (
      <>
        ...
        <div style={{
          ...
          <span style={{ color: '#58beff', fontWeight: 700 }}>{windFlowDirectionLabel(weather.windDir)}</span>
        </div>
      </>
    )
  }
