...
import { Calendar, MapPin, Users, Clock, ChevronLeft, Lock, Zap } from 'lucide-react'
        ...
        {event && (
          <div className="space-y-5">
            ...
            <div
              ...
              style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}
            >
              <div className="text-xs uppercase tracking-wide font-semibold mr-1" style={{ color: 'var(--text-muted)' }}>
                Organized by
              </div>
