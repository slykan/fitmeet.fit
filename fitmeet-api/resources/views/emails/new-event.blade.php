...
<head>
  ...
  <title>New Event Near You — FitMeet</title>
</head>
          ...
          <tr>
            <td style="background:#16161f;border:1px solid #2a2a3a;border-radius:20px;padding:36px 32px;">
              ...
              <p style="margin:0 0 28px;font-size:14px;color:#8888aa;text-align:center;line-height:1.5;">
                Hey {{ $recipient->name }}, there's a new activity that matches your interests.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                  <td>
                    ...
                    <p style="margin:14px 0 0;font-size:13px;color:#666688;line-height:1.6;border-top:1px solid #2a2a3a;padding-top:14px;">
          ...
          <tr>
            <td align="center" style="padding-top:28px;">
              <p style="margin:0;font-size:12px;color:#555570;line-height:1.6;">
                ...
                &nbsp;·&nbsp; You're receiving this because this event matches your interests and location.
              </p>
            </td>
          </tr>
