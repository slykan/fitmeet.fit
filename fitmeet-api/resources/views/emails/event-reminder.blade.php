...
<head>
  ...
  <title>Event Reminder — FitMeet</title>
</head>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
          ...
          <tr>
            <td style="background:#16161f;border:1px solid #2a2a3a;border-radius:20px;padding:36px 32px;">
              ...
              @php
                $label = match($reminder->remind_offset) {
                    '1h' => '1 hour',
                    '5h' => '5 hours',
                    '1d' => '1 day',
                    default => 'soon',
                ...
                $start = \Carbon\Carbon::parse($event->start_at);
              @endphp
              ...
              <p style="margin:0 0 28px;font-size:14px;color:#8888aa;text-align:center;line-height:1.5;">
                Don't forget — you're going to this event.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                  <td>
                      ...
                      <tr>
                        <td style="padding-bottom:8px;">
                          <span style="color:#8888aa;font-size:13px;">
                            ...
                            @if($event->elevation_gain) ↑{{ $event->elevation_gain }} m @endif
                          </span>
                        </td>
                      </tr>
                      @endif
                    ...
                    <p style="margin:14px 0 0;font-size:13px;color:#6666880;line-height:1.6;border-top:1px solid #2a2a3a;padding-top:14px;">
              ...
              {{-- Participants --}}
              @php $count = $event->participants_count; @endphp
              @if($count > 0)
              <p style="margin:0 0 24px;font-size:13px;color:#8888aa;text-align:center;">
                <strong style="color:#39FF14;">{{ $count }}</strong>
                {{ $count === 1 ? 'person is' : 'people are' }} joining this event.
              </p>
              @endif
